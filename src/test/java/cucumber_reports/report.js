$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/test/java/com/next/resources/features/ShouldBeAbleToSearchProduct.feature");
formatter.feature({
